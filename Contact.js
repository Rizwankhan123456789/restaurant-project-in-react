                    ...
                    <div className="col-12">
                        <div className="row gy-4">
                            <div className="col-md-4">
                                ...
                                <p><i className="fa fa-envelope-open text-primary me-2"></i>rizwanqadar155@gmail.com</p>
                            </div>
                            <div className="col-md-4">
            ...
            <div className="container py-5">
                <div className="row g-5">
                    ...
                    <div className="col-lg-3 col-md-6">
                        ...
                        <p>Pain is with love, just with love, chosen gathering, essence is chosen.</p>
